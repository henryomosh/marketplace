        ...
        <div className="bg-gray-100 rounded-md p-4 h-max">
              ...
              <div className="space-y-3">
                <div className="relative flex items-center">
                  <input
                    ...
                    className="px-4 py-2.5 bg-white text-gray-800 rounded-md w-full text-sm border-b focus:border-indigo-800 outline-none"
                  />
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="#bbb"
          ...
          <ul className="text-gray-800 mt-6 space-y-3">
            <li className="flex flex-wrap gap-4 text-sm">
              Subtotal <span className="ml-auto font-bold">Ksh65,000.00</span>
            </li>
            <li className="flex flex-wrap gap-4 text-sm">
              Shipping <span className="ml-auto font-bold">Ksh1200.00</span>
            </li>
            <li className="flex flex-wrap gap-4 text-sm">
              Tax <span className="ml-auto font-bold">Ksh800.00</span>
            </li>
            <hr className="border-gray-300" />
            <li className="flex flex-wrap gap-4 text-sm font-bold">
              Total <span className="ml-auto">Ksh67,000.00</span>
            </li>
          </ul>
          ...
          <div className="mt-6 space-y-3">
            <button
              type="button"
              className="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-indigo-800 hover:bg-indigo-900 text-white rounded-md"
            >
              Checkout
            </button>
            <button
              type="button"
              className="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-transparent text-indigo-800 border border-indigo-300 rounded-md hover:bg-indigo-800 hover:text-white"
            >
              Continue Shopping{" "}
            </button>
          </div>
